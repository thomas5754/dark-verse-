...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
          'https://slides-wales-obituaries-resumes.trycloudflare.com/deleteUser?key=$sessionKey&username=$username',
        ),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'https://slides-wales-obituaries-resumes.trycloudflare.com/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
