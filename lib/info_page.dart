...
class _InfoPageState extends State<InfoPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchServerInfo() async {
    try {
      await http
          .get(Uri.parse(
              'https://concerns-barn-roman-forth.trycloudflare.com/getServerInfo?key=${widget.sessionKey}'))
  ...
  Future<void> _checkApiPing() async {
    ...
    try {
      final res = await http
          .get(Uri.parse(
              'https://concerns-barn-roman-forth.trycloudflare.com/ping?key=${widget.sessionKey}'))
