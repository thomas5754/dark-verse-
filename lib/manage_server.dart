...
class _ManageServerPageState extends State<ManageServerPage> {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('https://slides-wales-obituaries-resumes.trycloudflare.com/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('https://slides-wales-obituaries-resumes.trycloudflare.com/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('https://slides-wales-obituaries-resumes.trycloudflare.com/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
